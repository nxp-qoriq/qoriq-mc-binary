...
## [10.24.401] - 2022-13-12
### Added
- **GLOBAL**
	* Enabled the LOG at the earlies time possible in the main()
	  function.
	* Added rudimentary debug prints in early MC boot process


## [10.24.400] - 2022-20-07
### Added
- **PEB**
	* Dump PEB error related register in the PEB error interrupt
	* Clear the source of the PEB ECC error before exiting the PEB error ISR
